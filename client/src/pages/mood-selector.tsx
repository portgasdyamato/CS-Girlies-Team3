    ...
    <section className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card rounded-3xl p-8 mb-8 pulse-glow">
          <h3 className="text-2xl font-semibold text-white mb-6 text-center">Choose Your Mood</h3>
          ...
          <div className="space-y-4">
            <Label className="text-white text-lg font-medium">Or describe your vibe:</Label>
            <Input 
              value={customMood}
              onChange={(e) => handleCustomMoodChange(e.target.value)}
              placeholder="e.g., 'sad baddie', 'soft girl in Paris', 'dark academia princess'" 
              className="w-full p-4 rounded-2xl glass-card text-white placeholder-purple-light bg-transparent border-2 border-lavender focus:border-pink-accent outline-none transition-all duration-300"
            />
